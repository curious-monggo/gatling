...
if(isset($_POST['company_name'], $_POST['company_code'], $_POST['infusionsoft_key'])){
	...
	//createCompany($_POST['company_name'], $_POST['company_code'], $_POST['infusionsoft_key'])
}
?>
    ...
    <section class="section">
      <div class="container">
 		<form action="create_company.php" method="POST">
	        <!-- Inputs -->
	        <h3 class="h4 text-success font-weight-bold mb-4">Create a company</h3>
	        <div class="mb-3">
	        ...
	        <div class="row">
	          ...
	          <div class="col-lg-2 col-sm-6">
	            <div class="form-group">
	              <div class="input-group mb-4">
	                <input name="company_code" class="form-control" placeholder="Code" type="text">
	              </div>
	            </div>
	          </div>
