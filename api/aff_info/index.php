...
function Post() {
    ...
    try {
        ...
        if(isset($payload["affContactId"]) && isset($payload["contactId"])){
            ...
            if(isset($responseGetContact[0]["FirstName"]) && isset($responseGetContact[0]["LastName"])){
                ...
                try {
                    ...
                    if(is_numeric($updateCon)) {
                        $responseMessage = "Aff info added";
                        $addResult = $app->grpAssign($payload["contactId"], 1185);
                        
                        if($addResult == true){
                            $responseMessage = "Activation code and tag 1185 added";
                        }  
                    } else {
            ...
            if(!isset($responseGetContact[0]['_AFFemail'])){

                $responseGetContact[0]['_AFFemail'] = "roundandjolly@gmail.com";
            } else {
                // var_dump(GetContact("Email", $responseGetContact[0]['_AFFemail'])); 
                // var_dump($responseGetContact[0]['_AFFemail']);
                if(empty(GetContact("Email", $responseGetContact[0]['_AFFemail']))) {
                    $responseGetContact[0]['_AFFemail'] = "roundandjolly@gmail.com";
                }
            }
            $responseGetAffContact = GetContact("Email", $responseGetContact[0]['_AFFemail']);
            var_dump($responseGetContact);
    //             //get aff info
